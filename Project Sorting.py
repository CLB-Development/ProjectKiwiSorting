...
def testSortAlgorithms(func, times, precision):
    totalTime = 0
    for i in range(times):
        ...
        totalTime += end - start
    output = 'On avarege, {} takes around {} seconds'.format(func.__name__, round(totalTime/times, precision))
    return output


print(testSortAlgorithms(bubbleSort, 100, 6))
print(testSortAlgorithms(selectionSort, 100, 6))
print(testSortAlgorithms(mergeSort, 100, 6))

#RESULTS from sorting ~2200 elements: 
#On avarege, bubbleSort takes around 0.554734 seconds
#On avarege, selectionSort takes around 0.290628 seconds
#On avarege, mergeSort takes around 0.018104 seconds
